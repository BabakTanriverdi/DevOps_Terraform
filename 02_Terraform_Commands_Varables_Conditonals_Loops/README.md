...
resource "aws_instance" "tf-ec2" {
  ...
  key_name      = "mod_1_key"  # write your pem file without .pem extension
  tags = {
    "Name" = "tf-ec2"
  }
}
...
```go
resource "aws_s3_bucket" "tf-s3" {
  bucket = "tf-test-bucket-babakt-13"
}
...
variable "s3_bucket_name" {
  default = "s3-bucket-variable-babaktpl-13"
}
...
variable "s3_bucket" {
  default     = "new-s3-bucket-babak-devops13-tr"
}
