...
- Install Terraform for AWS Linux 2023

https://developer.hashicorp.com/terraform/install

- Install dnf config-manager to manage your repositories.

https://docs.devnetexperttraining.com/static-docs/Terraform/docs/cli/install/yum.html
...
- Go to IAM Role and Attach `S3FullAccess` policy to the "terraform" role.
